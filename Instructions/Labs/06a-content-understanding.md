...
1. Alternatively, as a developer, you can also use code to submit a document for analysis to the *Document Fields* analyzer. The Foundry playground provides code samples. 
