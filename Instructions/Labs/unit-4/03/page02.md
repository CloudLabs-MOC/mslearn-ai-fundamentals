...
1. Now navigate to your newly created workspace. On the **left-hand menu**, click **“Workspaces” (1)**. Locate the workspace you just created **PCA_Anomaly_Model<inject key="Deployment ID" enableCopy="false"></inject> (2)**.
