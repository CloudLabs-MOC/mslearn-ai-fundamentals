...
3.	The teacher will direct students to read an article on how sensors can be used to collect data.
...
4. After reading the article, play this 4-minute video, also by Clemson University, that relates to the article: Irrigation. (Stop at 4:05)

5. The teacher will facilitate a classroom discussion based off the following questions. Students should jot their answers down in SREB_U3_L5_Handout.
