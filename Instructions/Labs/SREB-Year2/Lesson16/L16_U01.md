...
- Open Power BI App and navigate to My Workspace.

- Click New → Upload a file → Local file, and upload the provided traffic dataset (CSV file). You can find the file in path **C:\AllFiles\Unit 1-Lesson 16-Power BI Fundamentals**.
