...
In this lab, you connect to an Azure SQL Database, use the Query Editor to examine trucking tables (route_data, cargo_data), and run SQL queries (SELECT, GROUP BY, JOIN, ORDER BY) to analyze delays, cargo impacts, distances, and weather-related patterns.
...
> - If you need any assistance, please contact us at cloudlabs-support@spektrasystems.com. We are available 24/7 to help you out.
  ...
  <validation step="e4bc8125-d29d-4dd7-95ce-eafea092c311" />


## Summary

In this lab, you connected to an Azure SQL Database and used the Query Editor to explore the trucking tables, route_data and cargo_data. You ran SQL queries (SELECT, GROUP BY, JOIN, ORDER BY) to analyze delays, cargo impacts, distances, and weather-related patterns, aggregating and joining data to produce average delays by cargo type and shipment priority for a trucking dashboard. 
